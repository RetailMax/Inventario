...
class MovimientoStockControllerTest {
    ...
    // Define the base URL for the controller to avoid repetition and errors
    // Corresponds to /api/inventario/movimientos
    private static final String BASE_URL = "/api/inventario/movimientos"; // <--- CORRECTED BASE URL
    ...
    void testRegistrarMovimientoEntrada() throws Exception {
        ...
        mockMvc.perform(post(BASE_URL) // <--- USES CORRECTED BASE_URL
